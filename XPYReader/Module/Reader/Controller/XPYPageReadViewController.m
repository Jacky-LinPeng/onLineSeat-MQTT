...
@interface XPYPageReadViewController () <UIPageViewControllerDataSource, UIPageViewControllerDelegate, XPYReadViewControllerDelegate,XPYMQTTManagerProxy>
...
//       
//        [self setViewControllers:readViewController direction:UIPageViewControllerNavigationDirectionForward animated:YES completion:nil];
//
//    });
    ...
    [[XPYMQTTManager sharedInstance] sendTxtMessage:@"hhhhh" topicId:self.bookModel.bookId];
}
...
- (void)didReciveMessage:(NSString *)msg topicId:(NSString *)topicId {
...
- (void)didRecivePageChanged:(NSNumber *)pageNum topicId:(NSString *)topicId {
    if (![topicId isEqualToString:self.bookModel.bookId]) {
        return;
    }
