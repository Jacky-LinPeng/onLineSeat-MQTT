...
+ (UIColor *)colorRatio:(CGFloat)ratio fromColor:(UIColor *)fromColor toColor:(UIColor *)toColor {
    return [UIColor colorWithRed:([toColor getRed] - [fromColor getRed]) * ratio + [fromColor getRed]
                           green:([toColor getGreen] - [fromColor getGreen]) * ratio + [fromColor getGreen]
                            blue:([toColor getBlue] - [fromColor getBlue]) * ratio + [fromColor getBlue]
                           alpha:1.0f];
}
